                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="file" class="input" name="images" ref="images"  
                                   autocomplete="off">
                            <br>
                            <a class="text-primary" :href="images" target="_blank">
                                <b>
    ...
    export default {
        ...
        methods: {
            getslider() {
                ...
                axios.get(apiServiesRoutes.BASE_URL + apiServiesRoutes.SLIDER_FIND + '/' + id, {})
                    .then(response => {
                        ...
                        if (status) {
                            vm.title_ar = data.slider.ar.title;
                            vm.description_ar = data.slider.ar.description;

                            vm.title_en = data.slider.en.title;
                            vm.description_en = data.slider.en.description;

                            vm.images = data.slider.image;
                            return;
                        }
            ...
            postslider(e) {
                ...
                axios
                    .post(apiServiesRoutes.BASE_URL + apiServiesRoutes.SLIDER_UPDATE + '/' + id, formData, {
                        headers: {
