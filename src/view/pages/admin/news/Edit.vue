                ...
                axios.get(apiServiesRoutes.BASE_URL + apiServiesRoutes.NEWS_ALL + '/' + id, {})
                    .then(response => {
                        ...
                        if (status) {
                            ...
                            vm.description_ar = data.news.ar.description;

                            vm.title_en = data.news.en.title;
                            vm.publisher_name_en = data.news.en.publisher_name;
                            vm.description_en = data.news.en.description;
