    ...
    export default {
        ...
        methods: {
            getactivity() {
                ...
                axios.get(apiServiesRoutes.BASE_URL + apiServiesRoutes.ACTIVITY_FIND + '/' + id, {})
                    .then(response => {
                        ...
                        console.log(data)
                        if (status) {
                            vm.title_ar = data.activity.ar.title;
                            vm.description_ar = data.activity.ar.description;
                        ...
                        vm.$router.push({name: 'all_activity'})
                    })
                    .catch(err => {
            ...
            postactivity(e) {
                ...
                axios
                    .post(apiServiesRoutes.BASE_URL + apiServiesRoutes.ACTIVITY_UPDATE + '/' + id, formData, {
                        headers: {
